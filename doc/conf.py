...
project = 'gbasis'
copyright = '2018, The HORTON developers'
author = 'The HORTON developers'
...
latex_documents = [
    (master_doc, 'gbasis.tex', 'gbasis Documentation',
...
man_pages = [
    (master_doc, 'gbasis', 'gbasis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gbasis', 'gbasis Documentation',
     author, 'gbasis', 'One line description of project.',
     'Miscellaneous'),
]
